...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  initState() {
    ...
    (StaticVarMethod.notificationback)?getnotiList():StaticVarMethod.notificationback==true;

    _timerDummy =
        Timer.periodic(Duration(seconds: 10), (Timer t) => getnotiList());
    super.initState();
  }
                    ...
                    child: Card(
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Container(
                                  margin: EdgeInsets.only(left: 8,right: 8,top: 17,bottom: 8),
                                  ...
                                  child: Column(
                                    children: [
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          text:'Sometime you may not get notifications due to GPS coverage,'
                                              ' network error, battery, voltage issues and unsupported vehicles.',
                                          style: TextStyle(
                                            fontSize: 14,
  ...
  Widget message(int index){
    ...
    return Container(
      ...
      child: RichText(
        ...
        overflow: TextOverflow.ellipsis,
        text: TextSpan(
            text:'Your Device ' +StaticVarMethod.eventList[index].deviceName.toString() + ' generate events of :'+ StaticVarMethod.eventList[index].message.toString()+'',
            style: TextStyle(
                fontSize: textsize,
                color: Colors.grey.shade700,
                //fontWeight: FontWeight.bold
  ...
  Widget timeAndDate(int index){
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(StaticVarMethod.eventList[index].time.toString(),style: TextStyle(
            fontSize: 11,
            color: Colors.grey.shade700,
          ),
          ),
