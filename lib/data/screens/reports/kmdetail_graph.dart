...
class kmdetail_graph extends StatefulWidget {
  @override
  _kmdetailState createState() => _kmdetailState();
}

class _kmdetailState extends State<kmdetail_graph> {
  ...
  String distance_sum="O mi";
  String top_speed="O mi";
...
*/
  ...
  // _timerDummy = Timer(Duration(seconds: 2), () => showReport1(1,"Today"));
   _timerDummy = Timer(Duration(seconds: 3), () => showReport1(1,"yesterday"));
    _timerDummy = Timer(Duration(seconds: 8), () => showReport1(2,"2 day ago"));
    _timerDummy = Timer(Duration(seconds: 13), () => showReport1(3,"3 day ago"));
  }
