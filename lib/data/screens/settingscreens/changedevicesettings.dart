                          ...
                          children: <Widget>[
                            GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child:   Column(
                                      children: <Widget>[
                                        Image.asset("assets/tbtrack/car1_sidestop.png", height: imageSize,width: imageSize),
                                        Text('Wagan',  style: TextStyle(
                                            fontSize: 12,height: 2))
                                      ]
                                  )
                              ),
                          ...
                          children: <Widget>[
                            GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child:   Column(
                                      children: <Widget>[
                                        Image.asset("assets/tbtrack/car2_sidestop.png", height: imageSize,width: imageSize),
                                        Text('Car',  style: TextStyle(
                                            fontSize: 12,height: 2.0))
                                      ]
                                  )
                          ...
                          children: <Widget>[
                            GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child:   Column(
                                      children: <Widget>[
                                        Image.asset("assets/tbtrack/car3_sidestop.png", height: imageSize,width: imageSize),
                                        Text('Truck',  style: TextStyle(
                                            fontSize: 12,height: 2.0))
                                      ]
                                  )
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      if(changetype.contains("Change Name")){
                                        ...
                                        gpsapis.addsensors(device_id,changetext);
