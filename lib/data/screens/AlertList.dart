...
class ActivateAlert extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _ActivateAlertState();
}

class _ActivateAlertState extends State<ActivateAlert> {
