...
//  final LatLng _initialPosition = LatLng(-6.168033, 106.900467);
  ...
  List<String> carstatusList = ['All ', 'Moving', 'Stopped', 'Idle', 'Offline', 'Expired'];
  int starIndex = 0;
                          ...
                          Row(children:[Container(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                ...
                                (productData.driverData!.phone != null)?_launchCaller(productData.driverData!.phone):"";
                              /*  Navigator.push(
                                  context,
                                  MaterialPageRoute(
                              ...
                              child:   Text((productData.driverData!.name != null)?productData.driverData!.name:productData.time.toString(),
                                  style: TextStyle(
                                      fontSize: 11,
                                      color: SOFT_GREY
                                  )),
