...
class StreetViewPanoramaInitDemo extends StatefulWidget {
  StreetViewPanoramaInitDemo({Key? key}) : super(key: key);

  @override
  _LiveMapScreenState createState() => _LiveMapScreenState();
}

class _LiveMapScreenState extends State<StreetViewPanoramaInitDemo>{
          ...
          child: Stack(
            children: [
              FlutterGoogleStreetView(
                 ...
                 */
                //initPos: SAN_FRAN,
                initPos: LatLng(StaticVarMethod.lat, StaticVarMethod.lng),
