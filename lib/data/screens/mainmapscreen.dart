          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                /*Image.asset("assets/nepalicon/zoom_out.png",
                      height: 25, width: 25)*/
  ...
  void _filterdata(String val) async {
    ...
    if(val.contains("All")){
      ...
      for (int i = 0; i < devicesList.length; i++) {
        ...
        if (val.contains("Idle") && ignition.contains("true") &&
            double.parse(model.speed.toString()) < 1.0) {
          StaticVarMethod.devicelist.add(devicesList.elementAt(i));
        }
        else if (val.contains("Inactive") && model.online.toString().toLowerCase().contains("offline") &&
            model.time.toString().toLowerCase().contains("not connected")) {
          StaticVarMethod.devicelist.add(devicesList.elementAt(i));
        } else if (val.contains("Running") && model.online.toString().toLowerCase().contains("online")) {
          StaticVarMethod.devicelist.add(devicesList.elementAt(i));
        }  else if (val.contains("Stopped") && ignition.contains("false") &&
            model.time.toString().toLowerCase() != "not connected") {
          StaticVarMethod.devicelist.add(devicesList.elementAt(i));
        }
      }
              ...
              Container(
                //width: 40,
                  ...
                  child:  GestureDetector(
                    ...
                    child:   Image.asset("assets/nepalicon/cancel.png", height: 20,width: 20),
                  )),
        ...
        if (devicesList[i].speed!.toInt() > 0) {
         // iconpath = 'assets/tbtrack/truck_toprunning.png';
          ...
          if(StaticVarMethod.pref_static!.get(devicesList[i].deviceData!.imei.toString())!=null)
            ...
            double.parse(devicesList[i].speed.toString()) < 1.0) {
          //iconpath = 'assets/tbtrack/truck_topidle.png';
          iconpath = 'assets/tbtrack/car_topidle.png';
          color = Colors.yellow;
          label = devicesList[i].name.toString();
          if(StaticVarMethod.pref_static!.get(devicesList[i].deviceData!.imei.toString())!=null)
            iconpath =  "assets/tbtrack/"+StaticVarMethod.pref_static!.get(devicesList[i].deviceData!.imei.toString()).toString()+"topidle.png";
...
Future<BitmapDescriptor> getMarkerIcon(String imagePath, String infoText,
  ...
  Size markerSize = Size(110.0, 110.0);
